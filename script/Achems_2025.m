...
for mouse_i= 2
    ...
    for icondition = 1: length(iconditions)
        ...
        hold on
        plot([median(newpeaks), median(newpeaks)], [0, 80], 'k--')
        ...
        figure(figureB)
        subplot(Nodors, Nconcs, (iodor-1)*Nconcs + iconc)
        boxplot( newpeaks,80*ones(size(newpeaks)), 'orientation','horizontal')
...
synch_file = '/Users/barrab01/Documents/Repos/ephysMH/processed_data/synchrony_timeseries_PCx.mat'; % PCx
synch_condition_file = '/Users/barrab01/Documents/Repos/ephysMH/processed_data/synch_condition_Pcx.mat'; % PCx
...
p1= ranksum(Rcoeff(:, 1), Rcoeff(:, 2))
p2= ranksum(Rcoeff(:, 1), Rcoeff(:, 3))
%% Simply plotting synchrony as a function of intensity 
...
for i = 1: 2
    ...
    y = X(:,i); 
    hold on
    plot(Y(:, 1), X(:,i), 'o', 'MarkerFaceColor', 'k')
